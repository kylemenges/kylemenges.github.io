...
var base = Rebase.createClass({
  apiKey: "AIzaSyAy2F05xrf9fEM8qG_rsBxiT-JM4gGQH5M",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix7.firebaseio.com", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
      ...
      this.viewChanged('alpha')
        return movies.sort (function (a, b) {
        var nameA = movies.title.toUpperCase();
        var nameB = movies.title.toUpperCase();
        if (nameA < nameB) {
          return -1;
          }
          if (nameA > nameB) {
      ...
      this.viewChanged('map')
        return var mapped = movies.map(function(el, i) {
